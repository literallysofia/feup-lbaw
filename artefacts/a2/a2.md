...
2. Some Authenticated User's stories were moved to the Buyer,specifically "View history of previous purchases","Make Review","Edit Review" and "Remove Review".
3. Bussiness rules "Review" and "Offensive Reviews" were removed
4. User stories "Sign In", "View Users" , "Block Users" and "Unblock Users" were removed from the Administrator.
5. New user stories added to the Administrator, regarding the functionality to Add or Delete/Archive Properties,Categories and FAQ.
6. Clarified user stories regarding search methods and filter tags.
7. Clarified user stories regarding products properties and categories.
