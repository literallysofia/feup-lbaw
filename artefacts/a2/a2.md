...
| US07       | Search Products on a Search Bar                     | medium   | As a User, I want to be able to search for products by name on a Search Bar, so that I can easily find the products I require.       |
