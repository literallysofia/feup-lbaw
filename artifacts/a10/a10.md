...
> Describe how input data was validated, and provide examples to scenarios using HTML validation and server-side validation.
 ...
 Inputs are validated using some HTML, Javascript and PHP validators as shown in examples below:
...
The project was very well planned and the group stuck to the plan since the beginning, not making any changes at all.
...
<table>
    ...
    <tr>
     ...
     <tr>
        <td>NEW</td>
        <td>Add item to wishlist with session variable</td>
        <td></td>
        <td>Luís Martins</td>
        <td>100%</td>
    </tr>
